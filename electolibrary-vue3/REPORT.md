...
> Перед сдачей нужно заменить `USERNAME` и вставить реальную ссылку на репозиторий GitHub.
...
В отчёт после запуска проекта нужно вставить скриншоты:
